...
Google Tink also references JSR-305 and Error Prone annotations in its bytecode. Those annotations
are build-time metadata and are not part of the Android runtime. The generated ProGuard
configuration therefore includes the narrow rules recommended by R8's missing-class report:
